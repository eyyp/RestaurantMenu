    ...
    return( 
        <TouchableOpacity style={styles.button} onPress={()=>props.navigation()}>
            <View style={{marginTop:verticalScale(20),width:horizontalScale(182)}}>
                ...
                <Text style={{fontSize:26,fontFamily:'Impact-Stone',marginLeft:horizontalScale(10),color:'black',marginTop:verticalScale(15)}}>{data?.price}₺</Text>
                <Image 
                    style={{width:horizontalScale(40),height:verticalScale(10),alignSelf:'flex-start'}}
            ...
            {imageUri ? 
                ...
                />
                :   <View style={{backgroundColor:'black',width:horizontalScale(110),marginLeft: horizontalScale(25),height:verticalScale(146),borderRadius:999}}>
                        <ActivityIndicator 
