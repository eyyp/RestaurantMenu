    ...
    return( 
        <TouchableOpacity style={styles.button} onPress={()=>props.navigation()}>
            <View style={{marginTop:verticalScale(20),width:horizontalScale(182)}}>
                ...
                <Text style={{fontSize:20,fontFamily:'CoalhandLuke TRIAL',alignSelf:'flex-start',color:'white',marginTop:verticalScale(15)}}>{data?.price}₺</Text>
            </View>
            {imageUri ? 
                <Image 
                    style={styles.image}
                ...
                />
                :   <View style={{backgroundColor:'#FFF200',width:horizontalScale(110),marginLeft: horizontalScale(25),height:verticalScale(146),borderRadius:999}}>
                        <ActivityIndicator 
